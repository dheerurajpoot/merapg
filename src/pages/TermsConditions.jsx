...
const TermsConditions = () => {
	...
	return (
		<>
			<div className='md:mt-20 mx-auto px-4 py-12 sm:px-6 lg:px-8'>
				<div className='container mt-20 md:mt-2'>
					...
					<div className='space-y-8'>
						...
						<div>
							...
							<p className='text-muted-foreground'>
								...
								time, but we will provide you with advance
								notice of any changes. If you do not agree with
								the new fees, you may cancel your account.
							</p>
						</div>
						<div>
							<h2 className='text-2xl font-bold mb-4'>
						...
						<div>
							...
							<p className='text-muted-foreground'>
								These Terms of Service shall be governed by the
								laws of [Jurisdiction]. Any disputes arising
